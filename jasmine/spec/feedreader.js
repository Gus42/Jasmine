    ...
    */
    ...
    describe('The menu', function() {
        ...
        it('should be hidden by default', function() {
          ...
          */
        it('should changes visibility when menu icon is clicked', function() {
    ...
    describe('Initial Entries', function() {
        ...
        it('it should have at least an .entry in .feed', function() {
    ...
    describe('New Feed Selection', function() {
        ...
        it('should change content when a new feed is loaded', function() {
            ...
            expect(content !== oldContent).toBe(true);
        });
    });
}());
